...
export function AboutSection() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-10">
      <Card className="col-span-1 lg:col-span-3 border-none bg-gray-100 p-8">
        <CardHeader>
          <CardTitle className="text-4xl lg:text-6xl">
            Passionate and versatile Web Developer who loves to create.
          </CardTitle>
        </CardHeader>
        <CardDescription className="mt-4 text-muted-foreground lg:text-lg">
